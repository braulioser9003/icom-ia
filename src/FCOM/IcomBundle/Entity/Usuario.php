...
class Usuario implements AdvancedUserInterface, \Serializable
{
    ...
    /**
     * @var string
     * @Assert\NotBlank(message="Inserte la contraseña")
     *
     ...
     * Add notificacion
     *
     * @param \FCOM\IcomBundle\Entity\Notificacion $notificacion
     * @return Usuario
     */
    public function addNotificacion(\FCOM\IcomBundle\Entity\Notificacion $notificacion)
    {
     ...
     * @param \FCOM\IcomBundle\Entity\Notificacion $notificacion
     */
    public function removeNotificacion(\FCOM\IcomBundle\Entity\Notificacion $notificacion)
    {
